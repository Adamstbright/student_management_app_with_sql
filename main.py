...
class DatabaseConnection:
    def __init__(self, host="localhost", user="root", password="tobebe1995", database="school"):
        self.host = host
        self.user = user
...
class MainWindow(QMainWindow):
    ...
    def cell_clicked(self):
        ...
        # Clean all button widget from status bar
        children = self.findChildren(QPushButton)
        if children:
            for child in children:
                self.statusbar.removeWidget(child)

        # Add  edit and delete button to status bar
...
class AboutDialog(QMessageBox):
    def __init__(self):
        ...
        content = """ 
        This app was created to test my experience on PyQt6.
